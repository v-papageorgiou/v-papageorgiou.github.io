...
export const classes = {
  // Card styling
  card: `${colors.bgCard} rounded-lg p-4 border ${colors.borderCard} ${colors.borderCardHover} ${effects.shadowLg} ${effects.shadowCyanCard} ${transitions.default} ${effects.glowCyanCard}`,
  
  // Navigation link styling  
  navLink: `${colors.textNavLink} ${colors.textNavLinkHover} ${transitions.colors} ${effects.glowCyan}`,
  
  // Social icon styling
  socialIcon: `p-3 ${colors.bgSocialIcon} rounded-full border ${colors.borderSocial} ${colors.borderSocialHover} hover:bg-cyan-950/60 ${transitions.default} group ${effects.shadowLg} ${effects.shadowCyanHover} ${effects.glowCyanStrong}`,
  ...
  // CV button styling
  cvButton: `flex items-center space-x-2 px-4 py-2 ${colors.bgSocialIcon} rounded-lg border ${colors.borderSocial} ${colors.borderSocialHover} hover:bg-cyan-950/60 ${transitions.default} ${effects.shadowLg} ${effects.shadowCyanHover} ${effects.glowCyanStrong} ${colors.cyan} ${colors.textLinkHover}`,
} as const;
